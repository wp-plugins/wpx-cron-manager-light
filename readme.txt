...
* [Full Version](https://wpxtre.me/product/cron-manager)
...
1. Upload the entire content of plugin archive to your `/wp-content/plugins/` directory,
   so that everything will remain in a `/wp-content/plugins/wpx-cron-manager-light/` folder
...
You can try the complete version on wpXtreme [Followgram](https://wpxtre.me/product/cron-manager)
